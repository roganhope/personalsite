...
export function TypingAnimation({
  ...
  // Reset animation state during render (not in an effect) when the source
  // text changes, per React's recommended pattern for adjusting state in
  // response to a prop change.
  const [resetKey, setResetKey] = useState(animationSourceKey);
  if (resetKey !== animationSourceKey) {
    setResetKey(animationSourceKey);
    setDisplayedText("");
