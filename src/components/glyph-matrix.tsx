...
/**
 * An animated grid of subtly shifting glyphs, rendered to a canvas.
 * Ported from https://magicui.design/docs/components/glyph-matrix, with the
 * shadcn `cn()` helper dropped in favor of a plain join since this project
 * doesn't otherwise pull in clsx/tailwind-merge.
 */
